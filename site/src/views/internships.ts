...
export function renderInternships(ctx: Ctx, period: Period, geos: Record<string, GeoData>): string {
  ...
  out.push(card(ctx, { headingLevel: 2,
    ...
    provenance: provenance(ctx, { sourceIds: meta.vacancy_sources, updated: vacancyUpdated(ctx), n: interns }),
  ...
  out.push(card(ctx, { headingLevel: 2,
    ...
    provenance: provenance(ctx, { sourceIds: [...meta.vacancy_sources, "esco"], updated: vacancyUpdated(ctx), n: skills.total }),

...
export function renderCompare(ctx: Ctx, state: FilterState, data: Record<string, GeoData>, stats?: Stats): string {
  ...
  out.push(card(ctx, { headingLevel: 2,
    ...
    provenance: provenance(ctx, { sourceIds: meta.vacancy_sources, updated: vacancyUpdated(ctx), n: ict }),
  }));
  ...
  out.push(card(ctx, { headingLevel: 2,
    ...
    provenance: provenance(ctx, { sourceIds: [...meta.vacancy_sources, "esco"], updated: vacancyUpdated(ctx), n: tops[0].total + tops[1].total }),

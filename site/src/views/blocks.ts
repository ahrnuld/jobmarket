...
export function skillsCard(ctx: Ctx, data: GeoData, win: Window, geoId: string, programme: string,
  ...
  return card(ctx, {
    ...
    provenance: provenance(ctx, { sourceIds: [...meta.vacancy_sources, "esco"], updated: vacancyUpdated(ctx), n: res.total }),
...
export function rolesCard(ctx: Ctx, data: GeoData, win: Window, programme: string): string {
  ...
  return card(ctx, {
    ...
    provenance: provenance(ctx, { sourceIds: meta.vacancy_sources, updated: vacancyUpdated(ctx), n: famTotal }),
